                    ...
                    <div className='row'>
                        <div className='col-lg-6 col-md-7'>
                            <div className='header__top__left'>
                                <p>Free shipping, 7-days return or refund guarantee.</p>
                            </div>
                        </div>
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-4 col-md-3'>
                        <div className='header__nav__option'>
                            {/* <label htmlFor='search-input' href='#' className='search-switch'>
                                <img src='img/icon/search.png' alt='' />
                            </label>
                            <input type='checkbox' hidden name='' className='search__input' id='search-input' />
                            <label htmlFor='search-input' className='side__overlay'></label>
