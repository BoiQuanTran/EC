...
export default function Shop() {
    ...
    const handleSetFilterText = (event) => {
    ...
    const handleSetPriceFilter = (event) => {
        setFilterPriceTmp(event.target.value);
        debouncePrice(event.target.value);
    };
                                                            ...
                                                            <div className='row'>
                                                                <div className='col-sm-12'>
                                                                    <input style={{ width: '100%' }} type='range'
                                                                           min='0' max='200' className='form-range'
                                                                           value={filterPriceTmp} id='customRange1'
                                                                           onChange={(e) => handleSetPriceFilter(e)} />
