...
export default function ProductDetail() {
    ...
    const handleAddToCart = async () => {
        if (validateProductDetail()) {
            ...
            if(productDetailCreated.stock < quantity){
                notifyErrorMessage('Exceeds the quantity!')
                return 
            }
            const data = {
    ...
    const validateProductDetail = () => {
        if (sizeSelected === '' || colorSelected === '') {
            notifyErrorMessage('Please select size and color!')
            return false;
        }
                                    ...
                                    <div className='col-xs-12 col-sm-6 col-lg-6 col-md-6'>
                                        <div>
                                            ...
                                            <div className='d-flex mb-3'>
                                                ...
                                                &nbsp; | &nbsp;
                                                <div className='item-sku'>
                                                    NCC:<span className='vendor'>{supplier ? supplier.sortName : ' '}</span>
                                                </div>
                                                &nbsp; | &nbsp;
                                    ...
                                    <div className='col-lg-12'>
                                        <div className='product__details__tab'>
                                            <ul className='nav nav-tabs' role='tablist'>
                                                ...
                                                <li className='nav-item'>
                                                    <a className='nav-link' data-toggle='tab' href='#tabs-6' role='tab'>Customer Previews(5)</a>
                                                </li>
                                            </ul>
