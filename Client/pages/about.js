                        ...
                        <div className='col-lg-4 col-md-4 col-sm-6'>
                            <div className='about__item'>
                                ...
                                <p>Chúng tôi là một đội ngũ trẻ và nhiệt huyết, yêu thích thời trang và công nghệ, đã thành lập MEOW Eyewear với mong muốn mang đến cho khách hàng trải nghiệm mua sắm mắt kính đẳng cấp và tiện lợi nhất. 
                                    <br></br>Với sự sáng tạo và cam kết, chúng tôi luôn cập nhật những xu hướng mới nhất từ các thương hiệu nổi tiếng, đồng thời cam kết chất lượng để giúp khách hàng lựa chọn sản phẩm phù hợp nhất với phong cách cá nhân.</p>
                            </div>
                        </div>
                        <div className='col-lg-4 col-md-4 col-sm-6'>
                            <div className='about__item'>
                                ...
                                <p>Chúng tôi chuyên cung cấp các dòng sản phẩm mắt kính chất lượng cao từ kính râm, kính cận, kính chống ánh sáng xanh đến các phụ kiện kính mắt khác. 
                                    <br></br>Mỗi sản phẩm được chọn lọc kỹ lưỡng nhằm đảm bảo tính thẩm mỹ, sự bền bỉ và đáp ứng các tiêu chuẩn quốc tế về chất lượng. 
                                    <br></br>Ngoài ra, chúng tôi cũng hỗ trợ dịch vụ tư vấn chuyên nghiệp, giúp khách hàng chọn lựa sản phẩm hoàn hảo nhất cho nhu cầu của mình.</p>
                            </div>
                        </div>
                        <div className='col-lg-4 col-md-4 col-sm-6'>
                            <div className='about__item'>
                                <h4>Why Choose Us ?</h4>
                                <p>Chất lượng hàng đầu: Cam kết cung cấp sản phẩm có nguồn gốc rõ ràng và được kiểm tra chất lượng nghiêm ngặt.
                                    <br></br>Đa dạng lựa chọn: Hàng trăm mẫu mã từ các thương hiệu uy tín trong và ngoài nước, đáp ứng nhu cầu nhiều phong cách.
                                    <br></br>Dịch vụ khách hàng tận tâm: Đội ngũ tư vấn luôn sẵn sàng hỗ trợ và giải đáp thắc mắc của bạn.
                                    <br></br>Giá cả hợp lý: Chúng tôi cam kết mang lại mức giá cạnh tranh nhất trên thị trường.
                                    <br></br>Đến với MEOW Eyewear, bạn không chỉ sở hữu sản phẩm mà còn nhận được sự tận tâm từ một thương hiệu đáng tin cậy.</p>
                            </div>
                        </div>
                    </div>
                </div>
