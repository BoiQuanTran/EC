    ...
    const renderSwitch = (item) => {
        switch (item.status) {
            case SALE_ORDER_STATUS.PENDING:
                return <Chip label='Pending' color='success' />;
            case SALE_ORDER_STATUS.CONFIRM:
                return <Chip label='Confirm' color='primary' />;
            case SALE_ORDER_STATUS.DELIVERING:
                return <Chip label='Delivering' color='secondary' />;
            case SALE_ORDER_STATUS.COMPLETED:
                return <Chip label='Completed' color='warning' />;
